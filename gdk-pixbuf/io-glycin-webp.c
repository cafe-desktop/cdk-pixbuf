...
static gboolean
cdk_pixbuf__webp_is_save_option_supported (const gchar *option_key)
{
  return FALSE;
}
...
MODULE_ENTRY (fill_vtable) (GdkPixbufModule *module)
{
  ...
  module->save = cdk_pixbuf__webp_image_save;
  module->save_to_callback = cdk_pixbuf__webp_image_save_to_callback;
