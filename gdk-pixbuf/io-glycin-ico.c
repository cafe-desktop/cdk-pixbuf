...
static gboolean
cdk_pixbuf__ico_image_save_to_callback (GdkPixbufSaveFunc   save_func,
                                        gpointer            user_data,
                                        GdkPixbuf          *pixbuf,
                                        gchar             **keys,
                                        gchar             **values,
...
#else
#define MODULE_ENTRY(function) void _cdk_pixbuf__glycin_ico_ ## function
#endif
...
MODULE_ENTRY (fill_vtable) (GdkPixbufModule *module)
{
  ...
  module->save_to_callback = cdk_pixbuf__ico_image_save_to_callback;
