...
cdk_pixbuf__gdip_image_save_TIFF (FILE         *f,
                                 ...
                                 GError       **error)
{
  return cdk_pixbuf__gdip_image_save_TIFF_to_callback (gdip_save_to_file_callback, f, pixbuf, keys, values, error);
}
...
MODULE_ENTRY (fill_vtable) (CdkPixbufModule *module)
{
  ...
  module->save_to_callback = cdk_pixbuf__gdip_image_save_TIFF_to_callback;
