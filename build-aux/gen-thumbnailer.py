...
# Ancillary wrapper around cdk-pixbuf-print-mime-types that sets up a
...
argparser.add_argument('--printer', metavar='PATH', help='Path to cdk-pixbuf-print-mime-types')
...
if os.name == 'nt':
    ...
    newenv['PATH'] = cdk_pixbuf_dll_buildpath + os.pathsep + newenv['PATH']
