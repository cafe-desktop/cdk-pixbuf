...
test_composite1 (void)
{
  ...
  sub = cdk_pixbuf_new_subpixbuf (ref, 0, 0, 12, 12);

  cdk_pixbuf_fill (sub, 0x00ff0000);
...
test_composite2 (void)
{
...

  {
    ...
    cdk_pixbuf_fill (tmp, 0x00ccccff);
  ...
  pixels = cdk_pixbuf_get_pixels (src);
  p = pixels;
  p[0] = 0xff;
  p[1] = 0x00;
  p[2] = 0xff;
  p = pixels + (gsize)((cdk_pixbuf_get_height (src) - 1) * cdk_pixbuf_get_rowstride (src)) + (gsize)((cdk_pixbuf_get_width (src) - 1) * cdk_pixbuf_get_n_channels (src));
  p[0] = 0xff;
  p[1] = 0xff;
  p[2] = 0x00;
  ...
  dest = cdk_pixbuf_new (CDK_COLORSPACE_RGB,
                         ...
                         cdk_pixbuf_get_height (src) + 80);
  cdk_pixbuf_fill (dest, 0xffffffff);
  ...
  p = pixels + (gsize)((cdk_pixbuf_get_height (dest) - 1) * cdk_pixbuf_get_rowstride (dest)) + (gsize)((cdk_pixbuf_get_width (dest) - 1) * cdk_pixbuf_get_n_channels (dest));
  g_assert_cmpint (p[0], ==, 0xff);
